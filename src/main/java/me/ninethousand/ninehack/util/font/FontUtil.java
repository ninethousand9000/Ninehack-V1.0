...
public final class FontUtil {
    ...
    public static float drawString(boolean customFont, String text, int x, int y, Color color) {
        if (customFont) return NineHack.FONT_RENDERER.drawString(text, x, y, color);
    ...
    public static float drawStringWithShadow(boolean customFont, String text, int x, int y, Color color) {
        if (customFont) return NineHack.FONT_RENDERER.drawStringWithShadow(text, x, y, color);
    ...
    public static int getStringWidth(boolean customFont, String string) {
        if (customFont) {
            return NineHack.FONT_RENDERER.getStringWidth(string);
        } else {
    ...
    public static int getFontHeight(boolean customFont) {
        if (customFont) {
            return NineHack.FONT_RENDERER.getHeight();
        } else {
