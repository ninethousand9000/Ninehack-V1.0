...
public class EntityUtil implements NineHack.Globals {
    ...
    public static Vec3d getInterpolatedRenderPos(Entity entity, float partialTicks) {
        return EntityUtil.getInterpolatedPos(entity, partialTicks).subtract(((IRenderManager) EntityUtil.mc.getRenderManager()).getRenderPosX(), ((IRenderManager) EntityUtil.mc.getRenderManager()).getRenderPosY(), ((IRenderManager) EntityUtil.mc.getRenderManager()).getRenderPosZ());
    }

    public static Vec3d getInterpolatedRenderPos(Vec3d vec) {
        return new Vec3d(vec.x, vec.y, vec.z).subtract(((IRenderManager) EntityUtil.mc.getRenderManager()).getRenderPosX(), ((IRenderManager) EntityUtil.mc.getRenderManager()).getRenderPosY(), ((IRenderManager) EntityUtil.mc.getRenderManager()).getRenderPosZ());
    }
    ...
    public static List<Vec3d> getUntrappedBlocksExtended(int extension, EntityPlayer player, boolean antiScaffold, boolean antiStep, boolean legs, boolean platform, boolean antiDrop, boolean raytrace) {
        ...
        if (extension == 1) {
            ...
            int extend = 1;
            for (Vec3d vec3d : MathsUtil.getBlockBlocks(player)) {
    ...
    public static boolean isntValid(Entity entity, double range) {
        return entity == null || EntityUtil.isDead(entity) || entity.equals(EntityUtil.mc.player) || /*entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.getName()) ||*/ EntityUtil.mc.player.getDistanceSq(entity) > MathsUtil.square(range);
    }
